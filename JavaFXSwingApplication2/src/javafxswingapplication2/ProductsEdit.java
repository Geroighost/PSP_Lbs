...
public class ProductsEdit extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Новый тип:");

        jLabel5.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel5.setText("Новая цена:");
        ...
        jLabel3.setText("ID товара для изменения:");
        ...
        jLabel1.setText("Изменение товара");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String str1 = "EXEC dbo.UpdateProduct " + strr + ", '" + str + "', '" + strrr + "', '"+ strrrr + "'";
