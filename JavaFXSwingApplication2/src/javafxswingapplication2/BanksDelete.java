 ...
 * @author Swan
 */
public class BanksDelete extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Удаление банка");
        ...
        jLabel6.setText("Введите номер банка для удаления:");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       ...
       String str1 = "EXEC dbo.DeleteBank " + str + "";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BanksDelete.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } catch (InstantiationException ex) {
            java.util.logging.Logger.getLogger(BanksDelete.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } catch (IllegalAccessException ex) {
            java.util.logging.Logger.getLogger(BanksDelete.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
