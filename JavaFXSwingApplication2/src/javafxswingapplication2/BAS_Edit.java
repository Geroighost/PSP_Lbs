...
public class BAS_Edit extends javax.swing.JFrame {

    /**
     * Creates new form BAS_Edit
     */
    public BAS_Edit() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Изменение банковского счёта поставщика");
        ...
        jLabel3.setText("ID поставщика для изменения:");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String str1 = "EXEC dbo.UpdateSupplier_Bank " + strr + ", " + str + ", '" + strrr + "', '"+ strrrr + "'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BAS_Edit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } catch (InstantiationException ex) {
            java.util.logging.Logger.getLogger(BAS_Edit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } catch (IllegalAccessException ex) {
            java.util.logging.Logger.getLogger(BAS_Edit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
